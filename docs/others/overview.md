...
에슈르는 작중에서 마법 연구로 쌓은 지식의 풍부함을 보여주어 다른 요정들과는 달리 어느정도 상식적인 성격을 가지고 있다고 추측된다. 하지만 그녀 또한 {==마법이나 제빵 등 자신의 특기 분야가 아닌 경제나 학교 운영 쪽에서 크게 어리숙한 모습==}을 보여주면서, 요정 종족 특유의 어리숙한 성격을 바탕으로 가지고 있음을 드러냈다. 지난 일에 크게 연연해하지 않고 즐기는 모습도 요정 특유의 가벼운 성격 때문이다.
<br>
<br>
